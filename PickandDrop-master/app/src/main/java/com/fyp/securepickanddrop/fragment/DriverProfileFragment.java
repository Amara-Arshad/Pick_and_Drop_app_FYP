...
public class DriverProfileFragment extends Fragment {
    ...
    View view;
    ImageView userimg;
    TextView tv_user_name,tv_mobile,tv_email,tv_address,tv_edit_profile,tv_edit_vehicle,tv_change_passowrd,tv_invite_friend;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.driver_profile_screen, container, false);
        initializing();
        return view;
    }
    ...
    private void initializing() {
        ...
        tv_edit_vehicle=view.findViewById(R.id.txt_edit_vehicle);
        ...
        tv_edit_vehicle.setOnClickListener(view1 -> {
